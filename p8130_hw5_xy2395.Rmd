...
The variable `population` is a close call, with p-value = 0.052 $\sim 0.05$. I would keep it, because its p-value is quite close to 0.05. Also, adding 'population' contributes to the goodness of fit by increasing the adjusted R2 from 0.6939 to 0.7126. 
